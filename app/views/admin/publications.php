        ...
        <main>
            ...
            <div id="popup-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <form action="<?php echo URLROOT . '/Admin/deletePublication' ?>" method="POST">
...
<script>
    $(document).ready(function() {
        var endpoint = 'http://localhost/Kamikaze_Blog/admin/allPublications';
        fetch(endpoint)
            ...
            .then(data => {
                ...
                $('#users').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'prix', className: 'py-5 border-b border-gray-200 text-sm bg-white dark:bg-darker' },
                        { data: 'fullName', className: 'py-5 border-b border-gray-200 text-sm bg-white dark:bg-darker' },
                        { data: 'city', className: 'py-5 border-b border-gray-200 text-sm bg-white dark:bg-darker' },
                        { data: 'name', className: 'py-5 border-b border-gray-200 text-sm bg-white dark:bg-darker' },
    ...
    function toggleModal(id) {
        ...
        var userIdInput = document.getElementById("pubId");
