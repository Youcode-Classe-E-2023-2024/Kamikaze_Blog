...
<div class=" w-full h-screen flex flex-col justify-start items-center pt-16 my-9">
    ...
    <div class=" bg-gray-300 w-3/5 h-48 flex justify-center rounded-t-lg">
        <img src="data:image/jpeg;base64,<?php echo base64_encode($data['publication']->imgUrl); ?>" alt=""
            class=" w-96 h-48 rounded-xl">
                ...
                <div class=" w-full h-9 flex justify-between items-center  ">
                    <div class=" w-fit h-9 flex justify-center items-end gap-6 ">
                        <h1 class="text-2xl font-bold text-gray-700">
                            <?= $data['publication']->fullName; ?>
                        </h1>
                        <h2 class="text-sm  text-gray-600  font-bold">
                            <?= $data['publication']->name; ?>
                        </h2>
                    </div>
                    <h4 class="text-lg font-bold text-blue-500">
                        <?= $data['publication']->prix; ?>
                    </h4>
                </div>
