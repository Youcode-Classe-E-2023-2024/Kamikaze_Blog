            ...
            <div>
                ...
                <form action="<?php echo URLROOT ?>/Contact/index" method="post">
                    ...
                    <div class="form-group position-relative text-center pb-4">
                        ...
                        <input type="text" id="formName" name="name" class="w-[90%] form-control form-control-lg thick md:w-[50%]" placeholder="Name" value="<?php if (!empty($data["name"])) {
                                                                                                                                                                    echo $data["name"];
                                                                                                                                                                } ?>">
                    ...
                    <div class="form-group position-relative text-center pb-4">
                        ...
                        <input type="email" name="email" id="formEmail" class="w-[90%] form-control form-control-lg thick md:w-[50%]" placeholder="E-mail" value="<?php if (!empty($data["email"])) {
                                                                                                                                                                        echo $data["email"];
                                                                                                                                                                    } ?>">
                    ...
                    <div class="form-group message text-center pb-4">
                        <textarea id="formMessage" name="message" class="resize-none w-[90%] form-control form-control-lg md:w-[50%]" rows="7" placeholder="Message"><?php if (!empty($data["message"])) {
                                                                                                                                                                            echo $data["message"];
                                                                                                                                                                        } ?></textarea>
