        ...
        <main id="log" >
          <div class="w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">
              Don't have an account yet? <button id="regi" class="text-blue-600 hover:underline">Register</button>
            </div>
          </div>
        </main>
        <main id="reg" class="hidden ">
          <div class="w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">
              ...
              Already have an account? <button id="logi" class="text-blue-600 hover:underline">Login</button>
