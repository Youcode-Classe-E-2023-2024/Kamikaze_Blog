    ...
    <section>
        ...
        <div class="justify-center flex-1 max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
            <div class="max-w-lg mx-auto mb-12 text-center">
                <h2 class="mt-2 mb-4 text-3xl font-bold text-gray-700 dark:text-gray-400 md:text-4xl ">
                    Our Support Team
                </h2>
                ...
                <div class="w-full py-5 md:w-1/2 lg:w-1/3 md:px-5">
                    <div class="px-6 py-8 bg-white rounded shadow dark:bg-gray-700 border border-black">
                        <div class="flex items-center mb-4">
                            ...
                            <div class="pl-4">
                                <p class="text-xl font-bold dark:text-gray-300">Davina becham </p>
                                <p class="font-medium text-blue-600 dark:text-blue-400">Supervisor</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-start">
                            <a class="inline-block mr-5 text-blue-800 dark:text-gray-400 hover:text-blue-600" href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="w-full py-5 md:w-1/2 lg:w-1/3 md:px-5 ">
                    <div class="px-6 py-8 bg-white rounded shadow dark:bg-gray-700 border border-black">
                        <div class="flex items-center mb-4 ">
                            ...
                            <div class="pl-4">
                                <p class="text-xl font-bold dark:text-gray-300">Amit simon </p>
                                <p class="font-medium text-blue-600 dark:text-blue-400">Manager</p>
                            </div>
                        </div>
                        <p class="mb-4 leading-loose text-gray-500 dark:text-gray-400">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                ...
                <div class="w-full py-5 md:w-1/2 lg:w-1/3 md:px-5">
                    <div class="px-6 py-8 bg-white rounded shadow dark:bg-gray-700 border border-black">
                        <div class="flex items-center mb-4">
                            ...
                            <div class="pl-4">
                                <p class="text-xl font-bold dark:text-gray-300">Riyana ismith </p>
                                <p class="font-medium text-blue-600 dark:text-blue-400">Team Leader</p>
                            </div>
                        </div>
                        <p class="mb-4 leading-loose text-gray-500 dark:text-gray-400">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
